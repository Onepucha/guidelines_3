...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("less",(()=>{"use strict"
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    $(document).on("click", ".js-nextSpeech", function (event) {
        let block = $(event.target).parent().find('p.active');
    ...
    function tabs() {
        ...
        function onTabClickHandler(event) {
            ...
            let linksCollection = target.closest(".tabs").find(".tab__links");
    ...
    $("a.scrollto").click(function () {
        ...
        let destination = $(elementClick).offset().top - 75;
